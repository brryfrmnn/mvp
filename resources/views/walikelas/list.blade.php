                ...
                @endif
                    ...
                    <table class="table table-striped">
                        ...
                        @foreach ($user as $data) 
                            ...
                            <td><a href="{{URL('walikelas/nilai/lihatrapor?siswa_id='.$data->id.'&semester='.$data->siswa->semester.'&tahun_ajaran='.$data->siswa->tahun_ajar)}}" class="btn btn-primary"><i class="glyphicon glyphicon-edit"></i>Lihat Nilai</a>
